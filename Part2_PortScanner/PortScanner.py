...
TARGET = "127.0.0.1" # localhost for testing purposes. In real scenarios, this would be the IP address of the target machine. ONLY SCAN LOCAL HOST OR scanme.nmap.org OR IP ADDRESSES THAT YOU OWN.
START_PORT = 80
END_PORT = 100
